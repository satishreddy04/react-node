...
export const LoginComponent = () => {
  ...
  return (
    <div className={classes.root}>
      <Grid container>
        <Grid item xs={4} md={4} className={classes.loginContainer}>
        ...
        <Grid item xs={8} md={8} className={classes.imageContent}>
          <div className={classes.message}>{"Welcome to SKR Portfolio"}</div>
        </Grid>
      </Grid>
    </div>
  );
